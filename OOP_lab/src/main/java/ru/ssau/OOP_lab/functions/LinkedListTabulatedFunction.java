...
import ru.ssau.OOP_lab.exceptions.ArrayIsNotSortedException;
...
//    }
    ...
    @Override
    public Iterator<ru.ssau.OOP_lab.functions.Point> iterator() throws UnsupportedOperationException{
        return new Iterator<ru.ssau.OOP_lab.functions.Point>() {
